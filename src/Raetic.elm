...
We have labelled the sign variants with sub-numbers according to the frequency of occurrence, i.e.: Run A1 is the most frequent Elder Futhark Rune with the sound value A, Run A2 is the second most frequent Elder Futhark Rune with the sound value A etc. (There are exceptions from this basic rule, due to the iterative compilation of the sub-corpora.)
    """
    , tokens = tokens
